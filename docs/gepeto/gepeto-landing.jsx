    ...
    <section style={{ padding: "48px 0 56px", position: "relative" }}>
      ...
      >
        ...
        <div>
          ...
          <h1
            className="h-display hero-headline-mega"
            style={{
              fontSize: 88,
              lineHeight: 0.92,
          ...
          >
            O <b style={{ color: "var(--tertiary)" }}>Gepeto</b> é a IA da Figurinha
            Fácil. Ele palpita em todos os jogos da Copa antes de você, com análise
            técnica e provocação. Sua missão: acertar mais que a máquina.
          </p>
      ...
      >
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <div className="label-mono" style={{ fontSize: 9, marginTop: 6 }}>
              GEPETO
            </div>
          </div>
  ...
  return (
    <div
      style={{
        ...
        boxShadow:
          "0 30px 80px -20px rgba(0,0,0,0.7), inset 0 0 0 1px rgba(255,255,255,0.05)",
        position: "relative",
        overflow: "hidden",
        flexShrink: 0,
      }}
...
function PhoneCardScreen() {
  return (
    ...
    >
      <div className="label-mono" style={{ fontSize: 8, textAlign: "center" }}>
        QUARTAS · HOJE 21h
      </div>
      <div
        className="tcard"
        style={{ marginTop: 14, padding: 14, borderRadius: 16, position: "relative" }}
      >
        <div className="tcard-bg" />
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div className="label-mono" style={{ fontSize: 6 }}>
              CONFIANÇA
            </div>
          </div>
        </div>
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <div className="label-mono" style={{ fontSize: 7, marginTop: 2 }}>
              BRA
            </div>
          </div>
          <div className="h-display" style={{ fontSize: 13, color: "var(--muted)" }}>
            ×
          </div>
          <div style={{ textAlign: "center" }}>
            <div
    ...
    >
      ...
      {insights.map((i, n) => (
        ...
        >
          ...
          <div style={{ fontSize: 11, color: "var(--fg)", lineHeight: 1.3 }}>
            {i.text}
          </div>
        </div>
      ))}
    ...
    >
      <div
        style={{
          padding: 12,
          background:
            "linear-gradient(120deg, rgba(79,243,37,0.25), rgba(79,243,37,0.05))",
      ...
      >
        ...
        <div
          className="h-display"
          style={{ fontSize: 14, marginTop: 6, color: "var(--secondary)" }}
        >
          Você bateu a IA!
        </div>
        <div style={{ fontSize: 10, color: "#bff5ad", marginTop: 4 }}>
          +10 pts · streak 7🔥
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          <div className="label-mono" style={{ fontSize: 7 }}>
            VOCÊ
          </div>
          <div
            className="h-display num-mono"
            style={{ fontSize: 20, color: "var(--secondary)", marginTop: 4 }}
          >
            2-1
          </div>
        ...
        <div style={{ textAlign: "center", padding: 8, borderRadius: 8 }}>
          ...
          <div
            className="h-display num-mono"
            style={{ fontSize: 20, color: "var(--fg)", marginTop: 4 }}
          >
            2-2
          </div>
          ...
          <div
            className="num-mono"
            style={{ fontSize: 12, color: "var(--muted)", marginTop: 4, fontWeight: 700 }}
          >
            +10
          </div>
        </div>
...
function PhoneWeeklyScreen() {
  return (
    ...
    >
      <div className="label-mono" style={{ fontSize: 8, color: "var(--tertiary)" }}>
        CAPÍTULO 03 · QUARTAS
      </div>
      <div style={{ textAlign: "center", padding: "8px 0" }}>
        <GepetoAvatar size={56} mood="smug" />
        <div className="h-display" style={{ fontSize: 14, marginTop: 8 }}>
          Gepeto na liderança
        </div>
      </div>
      <div
      ...
      >
        <div style={{ textAlign: "center" }}>
          <div
            className="h-display num-mono"
            style={{ fontSize: 26, color: "var(--tertiary)" }}
          >
            11
          </div>
          <div className="label-mono" style={{ fontSize: 7 }}>
        ...
        <div className="h-display" style={{ fontSize: 16, color: "var(--muted)" }}>
          ×
        </div>
        <div style={{ textAlign: "center" }}>
          <div
            className="h-display num-mono"
            style={{ fontSize: 26, color: "var(--fg)" }}
          >
            9
          </div>
          <div className="label-mono" style={{ fontSize: 7 }}>
...
function HowItWorks() {
  ...
  return (
    <section
      id="como"
      style={{ padding: "96px 0", borderTop: "1px solid var(--outline-variant)" }}
    >
      <div className="lp" style={{ paddingTop: 0, paddingBottom: 0 }}>
    ...
    <section style={{ padding: "96px 0", borderTop: "1px solid var(--outline-variant)" }}>
      <div className="lp" style={{ paddingTop: 0, paddingBottom: 0 }}>
        <div style={{ marginBottom: 56, maxWidth: 640 }}>
          <div className="label-mono" style={{ color: "var(--secondary)" }}>
            O QUE TEM DENTRO
          </div>
          <h2
            className="h-display"
        ...
        >
          ...
          <div
            style={{
              padding: 28,
              background:
                "linear-gradient(135deg, rgba(149,170,255,0.08), transparent 60%), var(--container)",
              border: "1px solid var(--outline-variant)",
              borderRadius: 20,
              display: "flex",
              flexDirection: "column",
          ...
          >
            ...
            <h3
              className="h-display"
              style={{ fontSize: 28, marginTop: 8, letterSpacing: "-0.02em" }}
            >
            ...
            >
              Convite com código de 6 letras. Gepeto entra como adversário comum. Ranking,
              atividade, cutucadas, multiplicadores de mata-mata.
            </p>
            ...
            >
              {[
                ...
                >
                  ...
                  <div
                    className="num-mono"
                    style={{ fontSize: 12, fontWeight: 700, marginLeft: "auto" }}
                  >
                    {u.pts}pts
                  </div>
                </div>
          ...
          <div
            style={{
              padding: 28,
              background:
                "linear-gradient(135deg, rgba(79,243,37,0.06), transparent 60%), var(--container)",
              border: "1px solid var(--outline-variant)",
              borderRadius: 20,
              display: "flex",
              flexDirection: "column",
          ...
          >
            ...
            >
              Cada rodada que você bate o Gepeto vira badge. Compartilhe a streak no grupo
              do WhatsApp.
            </p>
            ...
            <div
              style={{
                ...
                padding: "20px 14px",
                background:
                  "linear-gradient(120deg, rgba(79,243,37,0.15), rgba(79,243,37,0.02))",
                border: "1px solid var(--secondary)",
                borderRadius: 14,
              }}
            >
              <div style={{ fontSize: 36 }}>🏆</div>
              <div className="h-display" style={{ fontSize: 14, marginTop: 6 }}>
                Você bateu a IA
              </div>
              <div style={{ fontSize: 11, color: "#bff5ad", marginTop: 4 }}>
                streak 7🔥 · +10 pts
              </div>
            </div>
          </div>
          ...
          <div
            style={{
              padding: 28,
              background:
                "linear-gradient(135deg, rgba(255,201,101,0.08), transparent 60%), var(--container)",
              border: "1px solid var(--outline-variant)",
              borderRadius: 20,
              display: "flex",
              flexDirection: "column",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          São <b style={{ color: "var(--fg)" }}>39 dias de Copa</b>. Toda partida é uma
          chance de provar que o Gepeto tá blefando.
        </p>
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 18, fontSize: 12, color: "var(--muted)" }}>
          <a href="Perfis.html" style={{ color: "inherit", textDecoration: "none" }}>
            Meu perfil
          </a>
          <a href="Cadastrar.html" style={{ color: "inherit", textDecoration: "none" }}>
            Álbum
          </a>
          <a href="Gepeto.html" style={{ color: "inherit", textDecoration: "none" }}>
            Gepeto
          </a>
        </div>
      </div>
