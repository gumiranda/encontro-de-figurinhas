    ...
    >
      ...
      <div className="relative space-y-8">
        <div className="flex items-center gap-3">
          <span
            className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--primary)] to-[var(--primary-dim)] shadow-[0_0_24px_rgba(149,170,255,0.35)]"
            aria-hidden="true"
          >
            <Landmark className="size-5 text-[var(--on-primary)]" strokeWidth={2.5} />
          </span>
          <span className="font-[var(--font-headline)] text-xl font-bold text-[var(--on-surface)]">
            Figurinha Fácil
          </span>
        </div>

        <h1 className="font-[var(--font-headline)] text-4xl font-black leading-tight tracking-tighter text-[var(--on-surface)]">
          Troque perto de{" "}
          <span className="text-gradient-primary">você.</span>
        </h1>

        <p className="max-w-sm text-lg leading-relaxed text-[var(--on-surface-variant)]">
