    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-center px-8 py-12 gap-6 w-full max-w-7xl mx-auto">
        ...
        <div className="flex gap-4">
          <button
            type="button"
            className="w-10 h-10 rounded-full bg-[var(--surface-container-high)] flex items-center justify-center text-[var(--outline)] hover:text-[var(--primary)] transition-colors border border-[var(--outline-variant)]/10"
