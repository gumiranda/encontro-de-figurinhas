    ...
    <section className="px-4 py-32 sm:px-6 md:py-40 relative overflow-hidden bg-primary">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <div className="flex justify-center">
          <div className="rounded-full p-[3px] bg-on-primary/15 ring-1 ring-on-primary/20">
            <Link
              href="/sign-up"
              className="group flex items-center gap-3 px-7 py-3.5 bg-on-primary text-primary-dim font-medium rounded-full shadow-[0_4px_24px_-4px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.8)] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_8px_32px_-4px_rgba(0,0,0,0.25)]"
            >
              Quero completar meu álbum
              <span className="flex items-center justify-center w-7 h-7 rounded-full bg-primary/10 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:translate-x-0.5 group-hover:bg-primary/15">
        ...
        <p className="text-on-primary/50 text-[0.6875rem] mt-6 uppercase tracking-[0.1em] font-medium">
          Sem cartão de crédito · 100% gratuito
        </p>

        <p className="text-on-primary/70 text-sm mt-12">
          <Link
            href="/ponto/solicitar"
            className="inline-flex items-center gap-1.5 font-medium underline decoration-on-primary/30 underline-offset-4 transition-colors duration-300 hover:text-tertiary hover:decoration-tertiary"
          >
