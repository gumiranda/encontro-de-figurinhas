      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <div className="flex justify-center">
          <div className="rounded-full p-[3px] bg-on-primary/15 ring-1 ring-on-primary/20">
            <Link
              href="/sign-up"
              className="group flex items-center gap-3 px-7 py-3.5 bg-on-primary text-primary-dim font-medium rounded-full shadow-[0_4px_24px_-4px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.8)] transition-[box-shadow] duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_8px_32px_-4px_rgba(0,0,0,0.25)]"
            >
