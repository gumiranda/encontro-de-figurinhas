    ...
    <Link href={`/cidade/${slug}`} className="block">
      <article className="group bg-[var(--landing-surface-container)] rounded-2xl border border-[var(--landing-outline-variant)]/10 overflow-hidden hover:border-[var(--landing-primary)]/40 transition-all duration-300">
        ...
        <div className="p-6">
          ...
          <span className="w-full mt-6 py-3 bg-[var(--landing-surface-container-highest)] group-hover:bg-[var(--landing-primary)] group-hover:text-[var(--landing-on-primary)] transition-all font-bold rounded-lg flex items-center justify-center gap-2 text-[var(--landing-on-surface)]">
