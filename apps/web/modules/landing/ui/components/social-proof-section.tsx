...
const STATS = [
  ...
  },
  {
    ...
    color: "text-[var(--landing-tertiary)]",
  },
  {
    icon: Star,
    value: "4.8",
...
export function SocialProofSection() {
  return (
    <section className="px-6 py-12 bg-[var(--landing-surface-container-low)]/50 border-y border-[var(--landing-outline-variant)]/10">
      <div className="max-w-7xl mx-auto">
        <p className="text-center text-[var(--landing-outline)] text-sm uppercase tracking-widest mb-8">
          ...
          {STATS.map((stat) => {
            ...
            return (
              <div key={stat.label} className="text-center">
                ...
                <p className="text-[var(--landing-outline)] text-sm mt-1">
                  {stat.label}
                </p>
              </div>
            );
