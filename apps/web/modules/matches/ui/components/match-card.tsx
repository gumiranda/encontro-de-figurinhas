...
import { MapPin, MessageCircle, Sparkles, Verified } from "lucide-react";
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          {(match.hasRareStickers ?? false) && (
            <Badge variant="outline" className="border-tertiary/25 bg-tertiary/10 text-tertiary text-[10px]">
              <Sparkles className="mr-1 size-3" />
              Com raras
            </Badge>
          )}
