          ...
          <div className="grid gap-4 md:grid-cols-2">
            {raretyTiers.map((tier) => {
              ...
              return (
                <div
                  key={tier.name}
                  className={`p-5 bg-[#f0ebe0]/70 rounded-xl border border-[var(--outline-variant)]/20`}
                >
                  <div>
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 py-12">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.pos}
                className="p-5 bg-[#f0ebe0]/70 rounded-xl border border-[var(--outline-variant)]/10 flex items-center justify-between"
              >
        ...
        <section className="mx-auto max-w-5xl px-4 sm:px-6 py-12">
          ...
          <div className="grid gap-6">
            {collectingStrategies.map((strategy, idx) => (
              <div
                key={idx}
                className="p-5 bg-[#f0ebe0]/70 rounded-xl border border-[var(--outline-variant)]/10"
              >
                <div>
                  <h3 className="text-xl font-semibold leading-none tracking-tight">{strategy.title}</h3>
                  <p className="text-base mt-2 text-[var(--outline)]">
              ...
              >
                <div>
                  <div className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#dc2626] text-[var(--on-primary)] flex items-center justify-center font-bold text-sm">
                      {idx + 1}
                    </span>
                    <h3 className="text-lg font-semibold leading-none tracking-tight">{tip.title}</h3>
                  </div>
                </div>
                <div className="pt-2">
