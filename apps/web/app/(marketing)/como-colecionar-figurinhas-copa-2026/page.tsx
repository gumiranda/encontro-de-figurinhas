          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {quickStats.map((stat) => {
              ...
              return (
                ...
                >
                  <div className="pb-2">
                    <div className="w-10 h-10 rounded-lg bg-[#f0ebe0]/70 flex items-center justify-center mb-2">
                      <Icon
                        className="h-5 w-5 text-[#535364]"
                        aria-hidden="true"
                      />
                    </div>
                    <p className="text-[10px] uppercase tracking-widest text-[var(--outline)]">
                      {stat.label}
                    </p>
                    <h3 className="text-2xl font-[var(--font-headline)] font-semibold">
                      {stat.value}
                    </h3>
                  </div>
                  <div className="pt-0">
        ...
        <section className="mx-auto max-w-3xl px-4 sm:px-6 py-12">
          ...
          <div className="space-y-4 text-[var(--on-surface-variant)] text-base md:text-lg leading-relaxed">
            ...
            <div className="rounded-2xl border border-[var(--outline-variant)]/20 bg-[var(--surface-container-high)] p-6">
              ...
              <div className="mt-6 p-4 rounded-lg bg-[#f0ebe0]/70">
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold">{place.place}</h3>
                    {place.available && (
              ...
              >
                <div>
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-lg font-semibold">{milestone.step}</h3>
